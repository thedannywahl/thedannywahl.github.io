...
export default function Construction() {
  return (
    <div class="flex min-h-[24em] justify-center items-center flex-col gap-8  bg-[#90bdbc] dark:bg-transparent dark:border-2 dark:m-4 lg:rounded-t-xl dark:rounded-xl p-4 sm:p-8">
